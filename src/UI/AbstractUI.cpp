...
void AbstractUI::swap(AbstractUI & _other)
{
	...
	std::swap(m_stretch, _other.m_stretch);
}
...
sf::Vector2f AbstractUI::getAnchorMin() const
{
	return m_anchorMin;
}

sf::Vector2f AbstractUI::getAnchorMax() const
{
	return m_anchorMax;
}
...
sf::Vector2f AbstractUI::getPivot() const
{
	return m_pivot;
}

sf::Vector2f AbstractUI::getPosition() const
{
	return m_position;
}

void AbstractUI::setStretch(Stretch _stretch)
{
	m_stretch = _stretch;
}

AbstractUI::Stretch AbstractUI::getStretch() const
{
	return m_stretch;
}

sf::Vector2f AbstractUI::getSize() const
{
	return m_size;
}
...
sf::Vector2f AbstractUI::getRealSize() const
{
...
bool AbstractUI::getEnabled() const
{
	return m_enabled;
}
...
bool AbstractUI::getFocused() const
{
	return m_focused;
}
...
void AbstractUI::getMargins(float & left, float & right, float & top, float & bottom) const
{
	left = m_marginLeft;
	right = m_marginRight;
	top = m_marginTop;
